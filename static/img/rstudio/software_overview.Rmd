---
title: "Overview of commonly used software"
...
## Overview
This slide deck contains information on the following software programs:
...
Up here there is an additional tab to see the *history* of 
the commands that you've previously entered.  

```{r}
grid.raster(readPNG("./rstudio-history.png"), interpolate=TRUE)
```
...
Most often your R studio window will have 4 panels. The top left is where you
write code or script, the console is now at the bottom. 
...
```
```{r, fig.width=8}
grid.raster(readPNG("./rstudio-working-command.png"))
```
...
The next two slides provide information on how to find your path. 
