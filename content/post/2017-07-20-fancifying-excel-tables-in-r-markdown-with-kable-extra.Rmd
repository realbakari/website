...
we're covering, what the studnets can do to prep for class, what i'm going to evaluate them
...
exam I hide the weeks prior to that exam so that the most current and upoming weeks are 
